...
- **Deployment**: Docker containers (server + worker + RustFS)
...
- [x] docker-compose.yml with RustFS + papermake-worker for local dev (no ClickHouse)
...
- [x] Integration tests with test S3/RustFS (partially in papermake-registry)
